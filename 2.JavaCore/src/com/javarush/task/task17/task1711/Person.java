...
public class Person {
    ...
    public void update(String name, Sex sex, Date birthDay){
        this.name = name;
        this.sex = sex;
        this.birthDay = birthDay;
    }
    ...
    public String toString() {
        String s  = this.sex.equals(Sex.MALE) ? "м" : "ж";
        return this.name + " " + s + " " + new SimpleDateFormat("dd-MMM-yyyy", Locale.ENGLISH).format(this.birthDay);
    }
}
